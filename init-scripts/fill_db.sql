...
(null, 2, 2500.00, 'DEPOSIT', 'Euro account opening'),
(null, 3, 7500.00, 'DEPOSIT', 'Initial deposit'),
(null, 4, 15000.00, 'DEPOSIT', 'Admin account funding'),
(1, 3, 500.00, 'TRANSFER', 'Gift to Maria'),
(3, 1, 250.00, 'TRANSFER', 'Lunch repayment'),
(1, 1, -200.00, 'WITHDRAWAL', 'ATM withdrawal'),
(3, 4, 1000.00, 'TRANSFER', 'Service payment');
